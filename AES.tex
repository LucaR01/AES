...
%TODO: sistemare titolo. (mettere il \centering)
...
\newcommand*{\titleRF}{\begingroup% Robert Frost, T&H p 149
	...
	{\Large }\\[0.5\baselineskip] %TODO: \plogo da problemi
...
\begin{document}
	...
	\include{Algoritmo} %TODO: oppure chiamarlo: "Meccanismo"?
	
	\include{La_matematica_dietro_AES}
	
	%TODO: Prima dell'implementazione facciamo: "Le modalità di AES" oppure anche prima del capitolo "La matematica dietro AES".
	
	%TODO: Implementazione
	
	%TODO: Pros e Cons (Tipi Attacchi su AES, ecc.)

...
%TODO: rimuovere il numerino della pagina nella pagina del titolo.
...
\newcommand*{\titleRF}{\begingroup% Robert Frost, T&H p 149
	...
	{\large v1.0.0}\\ %TODO: prima AES v1.0.0
	{\Large \scshape Maggio | Aprile}\par %TODO: al posto di The Publisher scrivere qualcos'altro; prima era AES v1.0.0; %TODO: cambiarlo
	{\large \scshape \hspace{2mm} 2022 | 2023}\\ %TODO: qui era year 2022
	{\includegraphics[width=0.6\textwidth, height=0.6\textheight, keepaspectratio]{./images/aes/500px-AES_(Rijndael)_Round_Function.png}} %TODO: remove?
	\vfill\null
	\endgroup}
...
\begin{document}
	...
	\include{Algoritmo} %TODO: oppure chiamarlo: "Meccanismo"/"Il Meccanismo"?
	...
	%TODO: Pros e Cons (Tipi Attacchi su AES, vulnerabilità?, ecc.) %TODO: volendo resistance to linear and differential cryptoanalysis, wide tail strategy, impractical related key attacks. %TODO: oppure chiamarlo Attacchi/Sicurezza di/su AES

...
\textsf{\small Per le altre colonne, vengono semplicemente eseguiti degli XOR con la stessa colonna della precedente chiave (eccetto per le chiavi a 256 bit che hanno un procedimento un po' più complicato).} \\ %TODO: rimuovere la parte tra parentesi? ovvero la parte procedimento un po' più complicato

\begin{comment} %TODO: mettere immagine a riguardo
\begin{figure}[H]
	\centering
...
\begin{itemize}
	...
	\item \textsf{\small \underline{\emph{Sub-bytes}}: } %TODO:
	\item \textsf{\small \underline{\emph{Shift Rows}}: } %TODO:
	\item \textsf{\small \underline{\emph{Mix Columns}}: } %TODO:
	\item \textsf{\small \underline{\emph{Add Round Key}}: } %TODO:
\end{itemize}
...
%TODO: immagine 500px-AES_(Rijndael)_Round_Function
